...
const About: React.FC = () => {
  ...
  const specialisms = [
    {
      ...
      icon: <Scale size={32} className="text-[#D9A13B]" />,
    },
    {
      title: "Facial harmonisation",
      icon: <Sparkles size={32} className="text-[#D9A13B]" />,
    },
    {
      title: "Skin rejuvenation injectables",
      icon: <Syringe size={32} className="text-[#D9A13B]" />,
    },
    {
      title: "Medical-grade skin treatments",
      icon: <ShieldCheck size={32} className="text-[#D9A13B]" />,
    },
  ];
  ...
  const heroTitleClass =
    "text-5xl md:text-7xl lg:text-8xl font-serif text-white leading-tight";
  const sectionTitleClass =
    "text-4xl md:text-6xl font-serif text-stone-900 leading-tight";
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="fade-in order-2 md:order-2 flex flex-col justify-center">
            <h2 className="text-4xl md:text-6xl font-serif text-stone-900 leading-none mb-8 flex items-center flex-wrap gap-x-4">
              Was founded{" "}
              <span className="font-script text-[#D9A13B] text-6xl md:text-8xl">
                by Liv
              </span>
            </h2>
            <div className={`${bodyTextClass} space-y-6 text-justify`}>
              <p>
                A Registered General Nurse with a lifelong passion for medical
                aesthetics, skin health, and confidence-building treatments.
              </p>
              <p>
                Before entering nursing, Liv operated a makeup artistry
                business, working closely with clients to enhance natural beauty
                and understand facial structure, skin, and individual features.
                After qualifying as a nurse, it became clear that the next step
                was to combine her artistic eye with medical knowledge, safety,
                and ethical practice…and that is where Apex Aesthetics Clinic
                was born.
              </p>
              <p>
              ...
              <p>
                Liv is now pursuing her dream career in aesthetics full time,
                having treated hundreds of clients with consistently safe and
                tailored outcomes. In 2026, Apex Aesthetics Clinic will also
                begin welcoming students and professionals into education and
                training, sharing high standards of practice and evidence-based
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-stretch">
          <div className="order-1 md:order-1 fade-in flex flex-col justify-center">
            ...
            <h2 className={sectionTitleClass}>
              Our Philosophy &{" "}
              <span className="font-script text-[#D9A13B] text-6xl md:text-8xl ml-2">
                Mission
              </span>
            </h2>
            <div className={`${bodyTextClass} space-y-6 text-justify mt-8`}>
              <p>
                Our mission at Apex Aesthetics Clinic is to remove the stigma
                surrounding cosmetic injectables and demonstrate that aesthetic
                enhancements can be subtle, responsible, and empowering.
              </p>
              <p>
                We believe cosmetic treatments should never change who you are -
                they should simply enhance what is already there. Every face is
                unique, and treatments are carefully tailored to suit individual
                features, proportions, and goals, ensuring clients still look
                like themselves; just more refreshed, balanced, and confident.
              </p>
              <p className="font-medium text-stone-800">
                Apex stands for ethical aesthetics, natural results, and
                long-term skin health.
              </p>
            </div>
            <div className="mt-10">
              <Button variant="primary" to="/training">
                View Academy
              </Button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className={`${bodyTextClass} italic`}>
              Each treatment plan is bespoke, focusing on facial balance,
              structure, and skin quality rather than trends or over-treatment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-[7.5rem] md:py-[15rem] overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-5xl md:text-7xl font-serif text-stone-900 leading-tight mb-8">
            A Safe Space for <br className="md:hidden" />{" "}
            <span
              className={`font-script text-6xl md:text-8xl block -mt-2 ${scriptStyle}`}
            >
              Confidence
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-16">
          <div className="max-w-2xl text-left">
            <h2 className={sectionTitleClass}>
              Your journey <br />{" "}
              <span
                className={`font-script text-6xl md:text-8xl ${scriptStyle}`}
              >
                starts here.
              </span>
            </h2>
            <p className={bodyTextClass}>
              Experience bespoke treatments designed around you. Enquire now to
              arrange your personalised consultation.
            </p>
          </div>
          <Button variant="primary" to="/contact" className="px-16 py-6">
            Enquire Now
          </Button>
        </div>
      </section>
