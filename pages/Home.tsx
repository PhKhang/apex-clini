      ...
      <section className="relative h-screen min-h-[600px] flex items-center bg-stone-50 overflow-hidden">
        ...
        <div className="relative z-10 text-left max-w-7xl mx-auto px-6 fade-in w-full">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-white mb-8 leading-tight">
            ...
            <span className={`font-script text-5xl md:text-8xl block -mt-2 ${scriptStyle}`}>Known for our Natural Results</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="fade-in">
            <h2 className="text-5xl md:text-7xl font-serif text-stone-900 leading-[1.1] mb-2">
              Empowering <br />
              Confidence Through <span className={`font-script text-6xl md:text-8xl inline-block ${scriptStyle}`}>Expertise</span>
            </h2>
            <div className="text-stone-600 font-light leading-relaxed mb-10 space-y-6">
               <p>At Apex Clinic, Nurse Olivia uses her extensive experience and artistic skills to create tailored treatments.</p>
            </div>
            <div className="flex flex-col items-start space-y-6">
              {['Dermal Fillers', 'Anti-Wrinkle Treatments', 'Skincare'].map((label, index) => (
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <h2 className="text-5xl md:text-7xl font-serif mb-4 text-stone-900">
              Meet <span className={`font-script text-6xl md:text-8xl inline-block ${scriptStyle}`}>Olivia</span>
            </h2>
            <div className="space-y-6 text-stone-600 font-light leading-loose text-lg">
              <p>With over a decade of clinical experience, Olivia has trained extensively and worked tirelessly to perfect her craft.</p>
            </div>
            <div className="mt-10">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            <div className="max-w-xl">
               <h2 className="text-5xl md:text-7xl font-serif mb-4 text-stone-900">
                Our <span className={`font-script text-6xl md:text-8xl inline-block ${scriptStyle}`}>Services</span>
               </h2>
             ...
             <div ref={scrollRef} className="flex gap-8 overflow-x-auto snap-x snap-mandatory pb-10 -mx-6 px-6 md:mx-0 md:px-0 scrollbar-hide">
               {services.map((service, idx) => (
                  <div key={idx} className="min-w-[85vw] md:min-w-[350px] snap-center flex flex-col h-full">
                     ...
                     <p className="text-sm text-stone-600 font-light leading-relaxed mb-8 italic flex-grow">{service.desc}</p>
                     <div className="mt-auto">
                        <Button variant="outline" to="/contact" className="border-none p-0 hover:bg-transparent hover:text-stone-600 font-bold tracking-widest text-xs uppercase">Book Now</Button>
                     </div>
                  </div>
               ))}
             </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white/50 backdrop-blur-sm rounded-[10px] overflow-hidden border border-stone-200/50 transition-all duration-300 hover:bg-white">
                ...
                >
                  <div className="px-8 pb-8 text-stone-600 font-light leading-relaxed text-base border-t border-stone-100 pt-6">
                    {faq.a}
                  </div>
                </div>
              </div>
          ...
          <div className="animate-marquee flex gap-8 py-4 whitespace-nowrap group-hover:pause">
            {[...testimonials, ...testimonials].map((review, i) => (
              <div key={i} className="inline-block w-[320px] bg-white rounded-[10px] shadow-sm border border-stone-100 p-8 hover:shadow-md transition-shadow">
                ...
                <p className="text-stone-600 font-light text-sm leading-relaxed italic whitespace-normal line-clamp-4">
                   "{review.text}"
                </p>
