...
const Home: React.FC = () => {
  ...
  const testimonials = [
    ...
    { name: "Jodie Foster", text: "Liv is awesome at what she does. Shes honest and not afraid to tell you what will and wont look best. I trust her opinion completely and I'm over the moon with the work shes done.", rating: 5, date: "1 week ago", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Jodie%20Foster", googleUrl: "https://maps.app.goo.gl/NAP3Be928ZHULWyL6" },
    { name: "Katie", text: "I’ve had so many treatments done by Liv and she smashes it every time, I’ve never walked out from an appointment feeling anything other than amazed. She listens and advises, there is no one I’d feel more comfortable and trusted with. X", rating: 5, date: "1 week ago", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Katie", googleUrl: "https://maps.app.goo.gl/fPinXFVkynR8YcY67" },
    { name: "Jasmine Smithson", text: "Liv is absolutely amazing at what she does, love all the treatments I’ve had so far! Liv explains all the treatments and after care in detail, would 100% recommend coming here!", rating: 5, date: "1 week ago", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Jasmine%20Smithson", googleUrl: "https://maps.app.goo.gl/BziAUt8iM1uieb2t8" },
    { name: "Sara Conner", text: "Absolutely love Liv . She is so professional and would never recommend a treatment if she didn’t think you needed it . The clinic is lovely and calming . 5* plus", rating: 5, date: "1 week ago", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sara%20Conner", googleUrl: "https://maps.app.goo.gl/9je527qzdhMkBEzu5 " },
    { name: "poppy rockley", text: "I highly recommend Apex. Liv is amazing and really tailors each treatment to you, making you feel really comfortable and at ease!", rating: 5, date: "1 week ago", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=poppy%20rockley", googleUrl: "https://maps.app.goo.gl/ka1Wj7EDKJcaapia7" },
    { name: "Amanda Bott", text: "Amazing experience with liv. Extremely professional equally friendly. Would recommend 100%", rating: 5, date: "1 week ago", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Amanda%20Bott", googleUrl: "https://maps.app.goo.gl/ZHdbBgom6jLxXWh86" },
    { name: "Kelly", text: "My favourite place to come! Always feel so relaxed and taken care of well, this is where the magic happens 😍x …", rating: 5, date: "1 week ago", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Kelly", googleUrl: "https://maps.app.goo.gl/39Nr1o1BBGgRSB1z8" },
  ];
...
const faqs = [
  ...
  { q: "Can I have treatments if I am pregnant?", a: `Aesthetic injectable treatments are not recommended for individuals who are pregnant or breastfeeding to ensure the absolute safety of both mother and child. We do however offer our "Mum to Be Facial" \n Our pregnancy safe facial treatment. Using our signature facial techniques, with added relaxation through massage. A luxury facial aimed to provide relaxation and de stress, whilst decongesting the skin. This treatment is the perfect pamper session and completely safe during pregnancy - no acids or chemicals will be used. Because mums deserve a pamper too!` },
...
>
  <div className="px-8 pb-8 text-stone-600 font-light text-lg leading-relaxed border-t border-stone-100 pt-6 whitespace-pre-line">
    {faq.a}
  </div>
</div>
              </div>
